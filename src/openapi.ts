...
* The \`id\` field is the technical PaymentAccount ID (e.g. \`"cuid_example"\`) that should be provided as \`paymentAccountId\` when creating transactions via \`POST /v1/transactions\`.`,
    ...
    '/v1/transactions': {
      post: {
        ...
        description: 'Creates a new dynamic QRIS payment transaction with an exact 5-minute expiry window. Calculates fee markup, assigns an auto-increment unique code (+1, +2, etc.) to prevent payment collision, and generates the EMVCo dynamic QR string.',
        ...
        responses: {
          ...
          '409': {
            description: 'Conflict - Duplicate active pending order ID',
            content: {
              'application/json': {
                schema: {
                  $ref: '#/components/schemas/ErrorResponse',
    ...
    schemas: {
      ...
      TransactionData: {
        ...
        properties: {
          ...
          qr_string: { type: 'string', description: 'EMVCo Dynamic QRIS payload string', example: '00020101021226590014ID.GO-PAY.WWW01189360091438999999990208123456785204581253033605405250015802ID5914Merchant Store6007Jakarta61051234062070703A016304ABCD' },
          ...
          expires_at: { type: 'string', format: 'date-time', description: 'ISO 8601 expiry timestamp (strictly 5 minutes from creation)', example: '2026-08-18T10:05:00.000Z' },
      ...
      TransactionDetailData: {
        ...
        properties: {
          ...
          qr_string: { type: 'string', example: '000201010212...' },
          customer_name: { type: 'string', nullable: true, example: 'John Doe' },
          customer_email: { type: 'string', nullable: true, example: 'customer@example.com' },
          metadata: { type: 'object', nullable: true },
